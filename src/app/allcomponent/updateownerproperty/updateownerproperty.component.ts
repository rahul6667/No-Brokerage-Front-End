...
@Component({
  selector: 'app-updateownerproperty',
  templateUrl: './updateownerproperty.component.html',
  styleUrls: ['./updateownerproperty.component.css']
})
export class UpdateownerpropertyComponent implements OnInit {
